...
$res=mysql_query("select * from galeriaimagenes",$con);
 ...
 <?php
                ...
                while($filas = $resultado->fetch_array(MYSQLI_ASSOC)) {
                    ...
                    if (file_exists("imagenes/".$filas["directorio"]."/".$filas["archivo"])){
                        echo'<tr> <th><a href="imagenes/'.$filas['directorio'].'/'.$filas['archivo'].'" rel="lightbox[galeria]" title="'.$filas['archivo'].'"></th><th><img width="150" height="150" src="imagenes/'.$filas['directorio'].'/'.$filas['archivo'].'"/></a></th>';
                    }
                }
            ?>
</td>
