...
<body onKeyDown="checkKey(event)" oncontextmenu="return false" onselectstart="return false" ondragstart="return false">
  ...
  <section id="portfolio">
    <div class="container wow fadeInUp">
      <div class="row">
        <div class="col-md-12">
          <h3 class="section-title">Gestor de datos</h3>
          <div class="section-title-divider"></div>
          <p class="section-description" style="font-size: 20px;">Administrador</p>
        </div>
      </div>
  ...
  <section id="subscribe">
    <div class="container wow fadeInUp">
      <div class="row">
        <div class="col-md-8">
          <h3 class="subscribe-title" style="font-size: 30px;">Solicitudes de empleo</h3>
          <p class="subscribe-text" style="font-size: 20px;">Verifica las solicitudes de empleo.</p>
        </div>
        <div class="col-md-4 subscribe-btn-container">
          <a class="subscribe-btn" href="lista.php">Aceptar</a>
        </div>
      </div>
    </div>
  </section>
...
<br>
  ...
  <section id="subscribe">
    <div class="container wow fadeInUp">
      <div class="row">
        <div class="col-md-8">
          <h3 class="subscribe-title" style="font-size: 30px;">Empleados</h3>
          <p class="subscribe-text" style="font-size: 20px;">Gestionar los datos de todos tus empleados.</p>
        </div>
        <div class="col-md-4 subscribe-btn-container">
          <a class="subscribe-btn" href="academia3/admin.php">Aceptar</a>
        </div>
      </div>
    </div>
  </section>
...
<br>
  <section id="subscribe">
    <div class="container wow fadeInUp">
      <div class="row">
        <div class="col-md-8">
          <h3 class="subscribe-title" style="font-size: 30px;">Galería de proyectos</h3>
          <p class="subscribe-text" style="font-size: 20px;">Gestiona tus proyectos realizados con la base de datos.</p>
        </div>
        <div class="col-md-4 subscribe-btn-container">
          <a class="subscribe-btn" href="publi.php">Aceptar</a>
        </div>
      </div>
    </div>
    </section>
    ...
    <!-- <br>
      <section id="subscribe">
        <div class="container wow fadeInUp">
          <div class="row">
            <div class="col-md-8">
              <h3 class="subscribe-title">Clientes</h3>
              <p class="subscribe-text">Gestiona los datos de todos los usuarios.</p>
            </div>
            <div class="col-md-4 subscribe-btn-container">
              <a class="subscribe-btn" href="gestorclientes.php">Aceptar</a>
            </div>
          </div>
        </div> -->
...
<script>
function myFunction() {
    bootbox.alert("Bienvenido Administrador");
}
</script>
</body>
