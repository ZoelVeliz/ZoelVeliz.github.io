  ...
  <section id="portfolio">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <p class="section-description" style="font-size: 18px;">Lista de Solicitudes</p>
        </div>
      </div>

      <img style= "display: block; margin: 0 auto; max-width: 100%; width: auto;" src="img/logo3.png" width="150" height="150">
      <br>


          <table table bgcolor= '#FFF' border='8'; style='font-size:21px'>
              <tr>
                  <th valign="middle" width="600">Nombre</th>
                  <th width="270">Email</th>
                  <!-- <td>tamaño</td>
                  <td>tipo</td> -->
                  <th width="999">Curriculum</th>
              </tr>
          <?php
