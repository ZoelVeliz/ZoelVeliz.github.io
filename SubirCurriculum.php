    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-has-children"><a href="nosotros.php">Nosotros</a>
            <ul>
              <li><a href="nosotros.php">Nuestra empresa</a></li>
              <li class="menu-has-children"><a href="SubirCurriculum.php">Unete al Equipo</a></li>
            </ul>
          </li>


            <ul>
              <li><a href="index.php #Montaje">Montaje</a></li>
              <li class="menu-has-children"><a href="index.php #Instalacion">Instalación</a>
                <ul>
                  <li><a href="index.php #Instalacion">Luminarias</a></li>
                </ul>
              </li>
              <li><a href="index.php #Mantenimiento">Mantenimiento</a></li>
            </ul>
          </li>
          <li><a href="cotizacion.php">Cotización</a></li>
          <li><a href="index.php #portfolio">Proyectos</a></li>
          <li><a href="contacto.php">Contacto</a></li>
         <li><a href="academia3/index.php">Iniciar Sesión</a></li>
          <li><a href="academia3/index.php">Registrarse</a></li>
        </ul>
      </nav>
      <!-- #nav-menu-container -->
    </div>
    ...
    <div class="container wow fadeInUp">
      <div class="row">
        <div class="col-md-12">
          ...
          <p class="section-description">Envianos tu curriculum en esta seccion</p>
        </div>
      </div>
        ...
        <div class="form" >
          ...
          <form method="post" action="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text"  onkeypress="return sololetras(event)" class="form-control" name="titulo" id="titulo"  placeholder="Nombre" maxlength="20" required autofocus>
                  <div class="validation"></div>
                </div>

                  <div class="form-group">

                      <input type="email"  onkeypress="return email(event)" class="form-control" name="descripcion" id="descripcion"  placeholder="Email" maxlength="35" required>
                      <div class="validation"></div>
                </div>
...
<br><br>
          <button type="submit" value="subir" name="subir" onclick="Mymensaje()">Enviar mensaje</button><br><br>
<h6>Nota: Su curriculum solo puede ser PDF, de lo contrario sera ignorado.</h6>
