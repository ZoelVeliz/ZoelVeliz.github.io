...
<body onKeyDown="checkKey(event)" oncontextmenu="return false" onselectstart="return false" ondragstart="return false">
  ...
  <section id="portfolio">
    <div class="container wow fadeInUp">
      <div class="row">
        <div class="col-md-12">
          <h3 class="section-title">Gestor de empleados</h3>
          <div class="section-title-divider"></div>
          <p class="section-description">Administrador</p>
        </div>
      </div>

      <div class="row">
        <div class="col-md-3">
          <a class="portfolio-item" style="background-image: url(img/insertar.png);" href="nuevoempleado.php">
            <div class="details">
              <h4>Nuevo empleado</h4>
              <span>Ingresar un nuevo empleado a la base de datos.</span>
            </div>
          </a>
        </div>

        <div class="col-md-3">
          <a class="portfolio-item" style="background-image: url(img/actualizar.png);" href="actempleado.php">
            <div class="details">
              <h4>Actualizar datos</h4>
              <span>Actualiza los datos de un empleado.</span>
            </div>
          </a>
        </div>

        <div class="col-md-3">
          <a class="portfolio-item" style="background-image: url(img/eliminar.png);" href="eliminarempleado.php">
            <div class="details">
              <h4>Eliminar empleado</h4>
              <span>Elimina los datos de un empleado en la base de datos.</span>
            </div>
          </a>
        </div>

        <div class="col-md-3">
          <a class="portfolio-item" style="background-image: url(img/buscar.png);" href="buscarempleado.php">
            <div class="details">
              <h4>Buscar</h4>
              <span>Buscar a un empleado específico en la base de datos.</span>
            </div>
          </a>
        </div>

        <div class="col-md-3">
          <a class="portfolio-item" style="background-image: url(img/registros.png);" href="verempleado.php">
            <div class="details">
              <h4>Ver registros</h4>
              <span>Observa los registros de todos tus empleados.</span>
            </div>
          </a>
        </div>
